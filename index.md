---
layout: page
title: 公認会計士 短答トレーナー サポート
permalink: /
---

「公認会計士 短答トレーナー」は、公認会計士試験・短答式試験の学習を支援する非公式アプリです。試験実施機関または関係団体が提供、承認、監修する公式アプリではありません。

## サポート

不具合、誤植、操作上の問題は、次の公開Issueから報告できます。

- [サポートIssueを作成する](https://github.com/shunki-235/cpa-short-answer-support/issues/new)
- [既存のIssueを確認する](https://github.com/shunki-235/cpa-short-answer-support/issues)
